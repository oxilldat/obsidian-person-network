...
const ru: Record<keyof typeof en, string> = {
	...
	"panel.companyStrength": "Притяжение по компаниям",
	...
	"layers.panelTitle": "Слои",
	"layers.empty": "Слои не настроены",
	"layers.toggleArea": "Показать или скрыть область слоя",
	"layers.toggleMembers": "Показать или скрыть участников слоя",
	"layers.assignHeading": "Слои",
	"settings.layersHeading": "Слои",
	"settings.layersDesc": "Наборы слоёв независимы для обычного графа и представлений Bases.",
	"settings.layerField.name": "Поле слоёв",
	"settings.layerField.desc": "Общее поле frontmatter со списком идентификаторов, например: layers: [family, work].",
	"settings.layer.scope": "Отображение",
	"settings.layer.scopeDesc": "Выберите представление, в котором будут настроены слои.",
	"settings.layer.add": "Добавить слой",
	"settings.layer.defaultName": "Новый слой",
	"settings.layer.name": "Название и цвет слоя",
	"settings.layer.namePlaceholder": "Название слоя",
	"settings.layer.identifierPlaceholder": "Идентификатор слоя",
	"settings.layer.identifier": "Идентификатор",
	"settings.layer.identifierDesc": "Значение, которое указывается в общем списке слоёв во frontmatter.",
	"settings.layer.icon": "Иконка Obsidian",
	"settings.layer.iconPlaceholder": "Поиск иконок Obsidian…",
	"settings.layer.iconCount": "Показано {{shown}} из {{total}}. Уточните поиск.",
	"settings.layer.showLabel": "Показывать подпись",
	"settings.layer.showIcon": "Показывать иконку",
	"settings.layer.raise": "Поднять приоритет слоя",
	"settings.layer.lower": "Опустить приоритет слоя",
};
